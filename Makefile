...
# Generated by qmake (2.01a) (Qt 4.5.1) on: Sun Nov 29 14:18:10 2009
...
SOURCES       = main.cpp \
		...
		observerdialog.cpp \
		canframeruleset.cpp \
		aboutbox.cpp moc_mainwindow.cpp \
		moc_readthread.cpp \
		moc_DevDialog.cpp \
		moc_errordialog.cpp \
...
$(TARGET): ui_mainwindow.h ui_DevDialog.h ui_errordialog.h ui_FilterDialog.h ui_filterdef.h ui_graphicwindow.h ui_candataitemselector.h ui_observerdialog.h ui_aboutbox.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QCanObserver1.0.0/ && $(COPY_FILE) --parents mainwindow.h readthread.h DevDialog.h candevice.h errordialog.h messagebufferinterface.h stringlistmodel.h FilterDialog.h filterdef.h graphicwindow.h processdatabase.h candataitemselector.h observerdialog.h canframeruleset.h aboutbox.h .tmp/QCanObserver1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp readthread.cpp DevDialog.cpp candevice.cpp errordialog.cpp messagebufferinterface.cpp stringlistmodel.cpp FilterDialog.cpp filterdef.cpp graphicwindow.cpp processdatabase.cpp candataitemselector.cpp observerdialog.cpp canframeruleset.cpp aboutbox.cpp .tmp/QCanObserver1.0.0/ && $(COPY_FILE) --parents mainwindow.ui DevDialog.ui errordialog.ui FilterDialog.ui FilterDialog.ui filterdef.ui filterdef.ui graphicwindow.ui candataitemselector.ui observerdialog.ui aboutbox.ui .tmp/QCanObserver1.0.0/ && (cd `dirname .tmp/QCanObserver1.0.0` && $(TAR) QCanObserver1.0.0.tar QCanObserver1.0.0 && $(COMPRESS) QCanObserver1.0.0.tar) && $(MOVE) `dirname .tmp/QCanObserver1.0.0`/QCanObserver1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QCanObserver1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_readthread.cpp moc_DevDialog.cpp moc_errordialog.cpp moc_messagebufferinterface.cpp moc_stringlistmodel.cpp moc_FilterDialog.cpp moc_filterdef.cpp moc_graphicwindow.cpp moc_candataitemselector.cpp moc_observerdialog.cpp moc_aboutbox.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_readthread.cpp moc_DevDialog.cpp moc_errordialog.cpp moc_messagebufferinterface.cpp moc_stringlistmodel.cpp moc_FilterDialog.cpp moc_filterdef.cpp moc_graphicwindow.cpp moc_candataitemselector.cpp moc_observerdialog.cpp moc_aboutbox.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_DevDialog.h ui_errordialog.h ui_FilterDialog.h ui_FilterDialog.h ui_filterdef.h ui_filterdef.h ui_graphicwindow.h ui_candataitemselector.h ui_observerdialog.h ui_aboutbox.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_DevDialog.h ui_errordialog.h ui_FilterDialog.h ui_FilterDialog.h ui_filterdef.h ui_filterdef.h ui_graphicwindow.h ui_candataitemselector.h ui_observerdialog.h ui_aboutbox.h
...
canframeruleset.o: canframeruleset.cpp canframeruleset.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o canframeruleset.o canframeruleset.cpp
